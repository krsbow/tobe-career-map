...
Standardized career-neutral assessment structured across 5 dimensions:
1. Standardized O*NET RIASEC Interest Profiler
2. 11-Domain Multi-Category Skill Inventory
3. Work Style & Environmental Preferences
4. Career Priorities & Values
5. Background & Education Level
"""
...
# 11 Comprehensive Multi-Domain Skill Categories
...
# Standardized O*NET Mini Interest Profiler (30 career-neutral activity questions)
ONET_INTEREST_QUESTIONS: List[Dict[str, Any]] = [
    # Realistic (R) - Hands-on, practical, physical, machinery
    ...
    # Investigative (I) - Analytical, intellectual, scientific, problem-solving
    ...
    # Artistic (A) - Creative, visual, self-expression, design, open-ended
    ...
    # Social (S) - Helping, teaching, advising, counseling, community
    ...
    # Enterprising (E) - Leading, pitching, persuading, managing, business
    ...
    # Conventional (C) - Organized, detail-oriented, systematic, procedural
...
# Primary Career-Neutral Assessment Questions Bank
ASSESSMENT_QUESTIONS: List[Dict[str, Any]] = [
    ...
    # 4. Optional Background / Education Level
    {
...
# Explanatory descriptions for RIASEC dimensions
RIASEC_DESCRIPTIONS: Dict[str, Dict[str, str]] = {
    "R": {
        "title": "Realistic (Doers)",
        "description": "Practical, hands-on, and mechanically inclined. You enjoy working with physical objects, tools, machinery, hardware, and tangible materials."
    },
    "I": {
        "title": "Investigative (Thinkers)",
        "description": "Analytical, intellectual, and scientific. You enjoy researching complex questions, analyzing data, solving mathematical puzzles, and understanding systems."
    },
    "A": {
        "title": "Artistic (Creators)",
        "description": "Creative, expressive, and innovative. You enjoy designing visual layouts, writing, crafting original concepts, and creating intuitive user experiences."
    },
    "S": {
        "title": "Social (Helpers)",
        "description": "Empathetic, communicative, and people-oriented. You find fulfillment in teaching, counseling, caring for health, and empowering communities."
    },
    "E": {
        "title": "Enterprising (Persuaders)",
        "description": "Ambitious, strategic, and persuasive. You enjoy initiating ventures, leading teams, pitching ideas, and driving business growth."
    },
    "C": {
        "title": "Conventional (Organizers)",
        "description": "Methodical, detail-oriented, and organized. You excel in managing structured data, ensuring financial accuracy, and maintaining quality standards."
    }
}
