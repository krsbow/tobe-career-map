// Real-World RIASEC & Skills Assessment Bank for TO BE Career Discovery Platform
// 18 structured questions covering Interests (RIASEC), Work Style, Problem Solving, and Values.
...
export const ASSESSMENT_QUESTIONS: AssessmentQuestion[] = [
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "id": "p_earning",
        "text": "High earning potential & financial growth"
      },
      {
        "id": "p_meaning",
        "text": "Meaningful social impact & helping people"
      },
      {
        "id": "p_learning",
        "text": "Continuous technical learning & curiosity"
      },
      {
        "id": "p_flexibility",
        "text": "Work flexibility / remote options"
      },
      {
        "id": "p_stability",
        "text": "Job stability & high industry demand"
      },
      {
        "id": "p_leadership",
        "text": "Leadership & strategic ownership"
      }
    ]
  },
  {
